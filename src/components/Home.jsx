      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full py-10 sm:py-52 px-4 md:flex-row">
        ...
        >
          ...
          <p className="text-gray-500 py-4 max-w-md">
            Hello! I'm Migara Kavishan, a dedicated and ambitious mobile app
            developer with a focus on Flutter. I am eager to learn and create
            seamless and intuitive applications that enhance user experiences.
          </p>
