...
const About = () => {
  const fileUrl =
    "https://drive.google.com/file/d/1oGY8cUx5q2qRr1LA8yPGqU1lKItYnhVt/view?usp=sharing";
  return (
    <div
      name="about"
      className="w-full bg-gradient-to-b h-screen from-gray-800 to-black text-white sm:pt-10 pt-96 pb-50"
    >
